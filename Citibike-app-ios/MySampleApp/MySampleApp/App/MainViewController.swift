...
class MainViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        var demoFeature = DemoFeature.init(
            name: NSLocalizedString("User Identity",
                comment: "Label for demo menu option."),
            detail: NSLocalizedString("View Your User Name",
                comment: "Description for demo menu option."),
            icon: "UserIdentityIcon", storyboard: "UserIdentity")
        
        demoFeatures.append(demoFeature)
        
        var demoVehicle = DemoFeature.init(
            name: NSLocalizedString("Drivers and Vehicle Info",
                                    comment: "Label for demo menu option."),
            detail: NSLocalizedString("Update Drivers and Vehicle Info",
                                      comment: "Description for demo menu option."),
            icon: "UserIdentityIcon", storyboard: "Vehicle")
        
        demoFeatures.append(demoVehicle)
        
  
        var demoShift = DemoFeature.init(
            name: NSLocalizedString("Shift Info",
                                    comment: "Label for demo menu option."),
            detail: NSLocalizedString("Start or End Shift",
                                      comment: "Description for demo menu option."),
            icon: "UserIdentityIcon", storyboard: "Shift")
        
        demoFeatures.append(demoShift)
        
        
        var demoTask = DemoFeature.init(
            name: NSLocalizedString("Task",
                                    comment: "Label for demo menu option."),
            detail: NSLocalizedString("Accept/Reject Task",
                                      comment: "Description for demo menu option."),
            icon: "UserIdentityIcon", storyboard: "Task")
        
        demoFeatures.append(demoTask)
        
        var demoCredits = DemoFeature.init(
            name: NSLocalizedString("Credit",
                                    comment: "Label for demo menu option."),
            detail: NSLocalizedString("Credits to Resources",
                                      comment: "Description for demo menu option."),
            icon: "UserIdentityIcon", storyboard: "Credits")
        
        demoFeatures.append(demoCredits)
        
//        var demoBreak = DemoFeature.init(
//            name: NSLocalizedString("Breaks",
//                                    comment: "Label for demo menu option."),
//            detail: NSLocalizedString("take breaks",
//                                      comment: "Description for demo menu option."),
//            icon: "UserIdentityIcon", storyboard: "Break")
//        
//        demoFeatures.append(demoBreak)
    }
